const firebaseConfig = process.env.FIREBASE_CRED
  ? process.env.FIREBASE_CRED
  : "{}";
export default {
  mode: "universal",
  components: true,
  ...
  head: {
    ...
    link: [
      ...
      {
        href:
          "https://fonts.googleapis.com/css?family=Poppins:100|Poppins:200|Poppins:300|Poppins:400|Poppins:500|Poppins:600|Poppins:700|Poppins:800|Poppins:900",
        rel: "stylesheet"
      }
    ],
    script: [
      {
        src: "https://kit.fontawesome.com/48d20e9c42.js",
